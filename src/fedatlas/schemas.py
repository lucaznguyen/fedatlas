...
SCHEMAS: dict[str, list[str]] = {
    ...
    "institutions": ["institution_id", "institution_name", "country_code", "country_iso3", "country_name"],
    "countries": ["country_code", "country_iso3", "country_name"],
    ...
    "paper_countries": ["work_id", "country_code", "country_iso3", "country_name"],
